...
*/
#define APP_I2C_DRV_I2C_INDEX   			    0
#define APP_I2C_PERPH_I2C_INDEX 			    I2C_ID_4

#define APP_I2C_DATABUFF_SIZE_BYTES          (APP_I2C_I2C_DRV_BYTE_COUNT)
#define APP_I2C_DATABUFF_SIZE_DWORDS         ((APP_I2C_I2C_DRV_BYTE_COUNT)/4)
