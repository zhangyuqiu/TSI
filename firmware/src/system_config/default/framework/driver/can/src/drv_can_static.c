...
void DRV_CAN0_Initialize(void)
{
    ...
    PLIB_CAN_FilterToChannelLink(CAN_ID_1, CAN_FILTER0, CAN_FILTER_MASK0, CAN_CHANNEL0);
    PLIB_CAN_ChannelEventEnable(CAN_ID_1, CAN_CHANNEL0, CAN_RX_CHANNEL_NOT_EMPTY);
    /* Configure CAN_ID_1 Channel for CAN_TX_RTR_DISABLED operation. Allocate 1 message buffer, and assign low medium priority for transmissions. */
    PLIB_CAN_ChannelForTransmitSet(CAN_ID_1, CAN_CHANNEL1, 1, CAN_TX_RTR_DISABLED, CAN_LOW_MEDIUM_PRIORITY);
    /* Configure CAN_ID_1 Channel for CAN_TX_RTR_DISABLED operation. Allocate 1 message buffer, and assign low medium priority for transmissions. */
    PLIB_CAN_ChannelForTransmitSet(CAN_ID_1, CAN_CHANNEL2, 1, CAN_TX_RTR_DISABLED, CAN_LOW_MEDIUM_PRIORITY);
    /* Configure CAN_ID_1 Channel for CAN_TX_RTR_DISABLED operation. Allocate 1 message buffer, and assign low medium priority for transmissions. */
    PLIB_CAN_ChannelForTransmitSet(CAN_ID_1, CAN_CHANNEL1, 1, CAN_TX_RTR_DISABLED, CAN_LOW_MEDIUM_PRIORITY);
    /* Configure CAN_ID_1 Channel for CAN_TX_RTR_DISABLED operation. Allocate 1 message buffer, and assign low medium priority for transmissions. */
    PLIB_CAN_ChannelForTransmitSet(CAN_ID_1, CAN_CHANNEL4, 1, CAN_TX_RTR_DISABLED, CAN_LOW_MEDIUM_PRIORITY);
    PLIB_CAN_FilterConfigure(CAN_ID_1, CAN_FILTER0, 0x201, CAN_SID);
    PLIB_CAN_FilterEnable(CAN_ID_1, CAN_FILTER0);
    PLIB_CAN_FilterConfigure(CAN_ID_1, CAN_FILTER1, 0x301, CAN_SID);
    PLIB_CAN_FilterEnable(CAN_ID_1, CAN_FILTER1);
    PLIB_CAN_FilterConfigure(CAN_ID_1, CAN_FILTER2, 0x401, CAN_SID);
    PLIB_CAN_FilterEnable(CAN_ID_1, CAN_FILTER2);
    PLIB_CAN_FilterConfigure(CAN_ID_1, CAN_FILTER3, 0x501, CAN_SID);
    ...
    PLIB_INT_VectorPrioritySet(INT_ID_0,INT_VECTOR_CAN1, INT_PRIORITY_LEVEL2);
